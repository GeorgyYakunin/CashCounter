...
public class AddSalesCashInAdapter extends RecyclerView.Adapter<AddSalesCashInAdapter.ViewHolder> {
    Context context;
    ...
    public AddSalesCashInAdapter(Context context, List<AddCashInOutItems> list) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.minusQty.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (((AddCashInOutItems) AddSalesCashInAdapter.this.itemsList.get(i)).getQty() > 0) {
                    ((AddCashInOutItems) AddSalesCashInAdapter.this.itemsList.get(i)).setQty(((AddCashInOutItems) AddSalesCashInAdapter.this.itemsList.get(i)).getQty() - 1);
                    AddSalesCashInAdapter.this.notifyItemChanged(i);
                    if (AddSalesCashInAdapter.this.setOnItemChange != null) {
                        AddSalesCashInAdapter.this.setOnItemChange.onQtyChanged();
                    }
                }
            }
        });
        ...
        viewHolder.viewQty.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                AddSalesCashInAdapter.this.openQtyPicker(i, viewHolder.txtCurreny.getText().toString().trim());
            }
        });
    }
    ...
    public void openQtyPicker(int i, String str) {
        ...
        numberPicker.setOnValueChangedListener(new OnValueChangeListener() {
            public void onValueChange(NumberPicker numberPicker, int i, int i2) {
                AddSalesCashInAdapter.this.lastChange = 1;
            }
        });
        textInputLayout.getEditText().addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                AddSalesCashInAdapter.this.lastChange = 2;
            }
        });
        ...
        button2.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (AddSalesCashInAdapter.this.lastChange == 1) {
                    AddSalesCashInAdapter.this.chenageQty(i2, numberPicker.getValue());
                } else if (AddSalesCashInAdapter.this.lastChange == 2) {
                    ...
                    if (textInputLayout.getEditText().getText().toString().trim().isEmpty() || parseInt == 0) {
                        ...
                        AddSalesCashInAdapter.this.chenageQty(i2, parseInt);
                    }
                }
                alertDialog.dismiss();
            }
